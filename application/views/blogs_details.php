...
<head>
  <meta charset="utf-8">
  <title><?php echo $blog_details[0]['title']; ?></title>
...
margin-bottom: 16px;
  ...
  .blog-details h3,p,li,a,strong,em{
  ...
  <header>
      ...
      <div class="header-bottom project-bottom-header">
        <!-- <div class="owl-carousel owl-theme owl-carousel-banner"> -->
          <div class="item">
            <img src="<?= base_url() . 'uploads/blogs/' . $blog_details[0]['images'] ?>" class="img-fluid" width="100%" alt="<?=$blog_details[0]['title']?>">
...
<div class="blog-tag-sec" style="display: none;">
<div class="container">
  
  <ul>
    <li><a href="#">Property Checklist</a></li>
    <li><a href="#">Real Estate Guide</a></li>
    <li><a href="#">Land Brokers</a></li>
    <li><a href="#">Property Checklist</a></li>
    <li><a href="#">Real Estate Guide</a></li>
    <li><a href="#">Land Brokers</a></li>
    <li><a href="#">Land Brokers</a></li>
...
<h3><?php echo $blog_details[0]['title']; ?></h3>
<?php echo $blog_details[0]['content']; ?>
</div>
